  ...
  return (
    <div className='xl:h-[59vw] md:h-[80vw] w-screen  md:pb-0 pb-[8vw]  text-black   bg-white flex flex-col gap-[3vw]' id='award'>
      <div className='md:w-[76%] xl:w-[70%] w-[97%] text-[#354962]   mx-auto fonts-text italic text-[20px] py-[0vw]'>
        <div className='flex items-center md:gap-[3vw] gap-[2vw] hidden xl:text-[25px]'>
          <div className='nowrap md:text-[2vw] text-[5vw] xl:text-[2.6vw] text-opacity-[0.4] text-[#354962] md:text-[3vw]'>Sponsored by</div>
      ...
      <div className="xl:w-[86%] md:w-[90%]  mx-auto  md:mt-[3vw] mt-[9vw] flex flex-col gap-[9vw] md:gap-[6vw]">
        <div className="fonts-text   italic text-center md:text-[6vw] text-[7vw]  xl:text-[56px] text-[#354962]">Grand Prize</div>
        <div className="flex  md:flex-row flex-col items-center justify-center gap-[7vw]  md:gap-[4vw]">
          <div className="">
            <div className="border-2 rounded-[20px] border-opacity-[0.2] relative border-[#919BC8]  md:w-[24vw] w-[65vw] xl:w-[25vw]">
          ...
          <div>
            <div className="border-2 rounded-[20px] border-opacity-[0.2] relative border-[#919BC8] md:w-[28vw] w-[65vw] xl:w-[25vw]">
