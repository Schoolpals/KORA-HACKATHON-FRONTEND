    ...
    <div className='xl:h-[59vw] md:h-[80vw] w-screen  md:pb-0 pb-[8vw]  text-black   bg-white flex flex-col gap-[3vw]' id='award'>
      <div className='md:w-[76%] xl:w-[70%] w-[97%] text-[#354962]   mx-auto fonts-text italic text-[20px] py-[0vw]'>
        <div className='flex items-center md:gap-[3vw] gap-[2vw]  xl:text-[25px]'>
          <div className='nowrap md:text-[2vw] text-[5vw] xl:text-[2.6vw] md:text-[3vw]'>Sponsored by</div>
      ...
      <div className="xl:w-[86%] md:w-[90%]  mx-auto  md:mt-[3vw] mt-[9vw] flex flex-col gap-[9vw] md:gap-[6vw]">
        ...
        <div className="flex  md:flex-row flex-col items-center justify-center gap-[5vw]  md:gap-[4vw]">
          <div className="">
            <div className="border-2 rounded-[20px] border-opacity-[0.2] relative border-[#919BC8]  md:w-[28vw] w-[70vw] xl:w-[25vw]">
              ...
              <div className="p-1 rounded-[20px]  bg-gray-100">
                <div className="bg-gradient-to-t from-[#979799] via-bg-gray-400 to-[#FBFCFF] md:h-[39vw] h-[65vw] xl:h-[31vw] text-black rounded-[20px] border-2">
                  <div className="w-[80%] mx-auto  my-[9vw]  md:my-[2rem]">
                    <div className="flex flex-col  justify-center md:gap-[1.5vw] gap-[2vw] xl:gap-[2vw]">
                      ...
                      <div className="flex flex-col gap-[1.3vw]">
                        ...
                        <div className="text-[#324154] italic md:text-[1.5vw] text-[3vw] xl:text-[1vw] fonts-text">What’s included?</div>
                      </div>
                      <div className="flex flex-col gap-4  xl:gap-3 md:gap-2">
                        <div className="flex gap-[1vw] xl:text-[1vw] md:text-[1.35vw] text-[3vw] items-center">
                          <FaStar />
                          <div>
          ...
          <div>
            <div className="border-2 rounded-[20px] border-opacity-[0.2] relative border-[#919BC8] md:w-[28vw] w-[70vw] xl:w-[25vw]">
              ...
              <div className="p-1 rounded-[20px]  bg-[#CC9F42] bg-opacity-[0.15]">
                <div className="bg-gradient-to-b from-[#CC9F4299] via-bg-[#874E0199] to-[#874E0199] md:h-[39vw] xl:h-[31vw] h-[65vw] text-black bg-opacity-[0.4] rounded-[20px] border-2">
          ...
          <div>
            <div className="border-2 rounded-[20px] border-opacity-[0.2] relative border-[#919BC8] md:w-[28vw] w-[70vw] xl:w-[25vw]">
              ...
              <div className="p-1 rounded-[20px] bg-[#C2A07A] bg-opacity-[0.15]">
                <div className="bg-gradient-to-b from-[#C2A07A80]  via-bg-gray-400 to-[#61513D80]  md:h-[39vw] h-[65vw] xl:h-[31vw] text-black bg-opacity-[0.4] rounded-[20px] border-2">
