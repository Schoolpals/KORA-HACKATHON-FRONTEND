          ...
          <div className="">
            <div className="border-2 rounded-[20px] border-opacity-[0.2] relative border-[#919BC8]   md:w-[28vw] w-[65vw] xl:w-[25vw]" data-aos="fade-up"
              ...
              <div className="p-1 rounded-[20px]  bg-gray-100">
                <div className="bg-gradient-to-t from-[#979799] via-bg-gray-400 to-[#FBFCFF] md:h-[39vw] h-[65vw] xl:h-[26vw] text-black rounded-[20px] border-2">
          ...
          <div>
            <div className="border-2 rounded-[20px] border-opacity-[0.2] relative border-[#919BC8] md:w-[28vw] w-[65vw] xl:w-[25vw]" data-aos="fade-up"
              ...
              <div className="p-1 rounded-[20px]  bg-[#CC9F42] bg-opacity-[0.15]">
                <div className="bg-gradient-to-b from-[#CC9F4299] via-bg-[#874E0199] to-[#874E0199] md:h-[39vw] xl:h-[26vw] h-[65vw] text-black bg-opacity-[0.4] rounded-[20px] border-2">
          ...
          <div>
            <div className="border-2 rounded-[20px] border-opacity-[0.2] relative border-[#919BC8] md:w-[28vw] w-[65vw] xl:w-[25vw]" data-aos="fade-up"
              ...
              <div className="p-1 rounded-[20px] bg-[#C2A07A] bg-opacity-[0.15]">
                <div className="bg-gradient-to-b from-[#C2A07A80]  via-bg-gray-400 to-[#61513D80]  md:h-[39vw] h-[65vw] xl:h-[26vw] text-black bg-opacity-[0.4] rounded-[20px] border-2">
