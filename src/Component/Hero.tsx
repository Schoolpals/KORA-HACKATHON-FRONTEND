    ...
    <div className='  xl:h-[54dvw]  md:h-[110dvw] h-[90dvh] overflow-hidden w-full text-white Hero'>
      <div className='w-[87%] mx-auto'>
        ...
        <div className='xl:flex xl:h-full justify-center'>
          <div className='xl:h-[47.5vw] gap-[2vw] w-[86%] xl:pt-0  md:h-[70vw] h-[68vh]  justify-center flex flex-col hero_text '>
            ...
            <div className='flex flex-col gap-[2vw] xl:h-[11.5vw]  '>
              ...
              <Link to="form" className='cursor-pointer' activeClass="active" spy={true} offset={0} smooth={true} duration={500}>
                <button className='w-[191px] rounded-[7px] h-[48px] bg-[#2961ED]' >
                  Register Now
                </button>
              </Link>
