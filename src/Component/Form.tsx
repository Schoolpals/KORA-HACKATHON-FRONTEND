...
export const Form = () => {
    return (
        <div className='xl:h-[80vh] justify-center items-center flex md:my-[0vw] xl:my-[4rem] xl:pt-[6.5vw] w-screen' id='form'>
            <div className='w-[84%] md:h-[30vw] relative px-[3vw] xl:h-[45vh] gap-[12vw] items-center justify-center p-[2.5vw] text-white  gap-[6vw] mx-auto bg-[#102649] rounded-[10px] md:rounded-[20px]'>
                <div className='flex flex-col   gap-[1vw]'>
                    <div className='fonts-text  text-[2vw] md:text-[24px]'>Ready to join the Kora Hackathon?</div>
