...
export const Form = () => {
    return (
        <div className='xl:h-[55vw] justify-center items-center flex md:my-[0vw] xl:my-[4rem] h-[70vw] my-[2vw]  md:h-[78vw] xl:pt-[0vw] w-screen' id='form'>
            <div className='w-[84%] md:h-[55vw] h-[30vw] relative px-[3vw] xl:h-[40vw] gap-[12vw] items-center justify-center p-[2.5vw] text-white  gap-[6vw] mx-auto bg-[#102649] rounded-[10px] md:rounded-[20px]'>
